...
import TimeToRestoreChart from "./TimeToRestoreChart.vue";
import "../../index.css";
import { infoForStatusItem } from "../../types";
import { walkIdentifiers } from "@vue/compiler-core";

beforeEach(() => {
  cy.intercept("GET", "**metrics/TimeToRestore*", {
    fixture: "timetorestore.json",
  }).as("timetorestoreData");
...
it("Chart is Visible", () => {
  ...
  cy.get("div").contains("Less than one week");
});
